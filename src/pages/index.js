        ...
        <main>
          <div className="divide-y divide-gray-200">
            <Head>
              ...
              <meta name="twitter:site" content="@heyjamshid" />
              <meta name="twitter:creator" content="@heyjamshid" />
              <meta name="twitter:title" content="Personal Blog - Jamshidbek" />
              ...
              <title>Jamshidbek Tashpulatov</title>
            ...
            <div className="pt-6 pb-8 space-y-2 md:space-y-5">
              ...
              <p className="text-lg text-gray-500">
                All the latest articles and tips here. 
              </p>
            </div>
